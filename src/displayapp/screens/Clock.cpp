    ...
    screen {[this, &settingsController]() {
      switch (settingsController.GetWatchFace()) {
        ...
        case WatchFace::CasioStyleG7710:
          ...
          break;
        case WatchFace::Origin:
          return WatchFaceOrigin();
          break;
      }
      return WatchFaceDigitalScreen();
    }()} {
...
std::unique_ptr<Screen> Clock::WatchFaceOrigin() {
  return std::make_unique<Screens::WatchFaceOrigin>(dateTimeController,
                                                             batteryController,
                                                             bleController,
                                                             notificationManager,
                                                             settingsController,
