#include "displayapp/screens/WatchFaceOrigin.h"
...
WatchFaceOrigin::WatchFaceOrigin(Controllers::DateTime& dateTimeController,
...
WatchFaceOrigin::~WatchFaceOrigin() {
...
bool WatchFaceOrigin::IsAvailable(Pinetime::Controllers::FS& filesystem) {
  lfs_file file = {};
